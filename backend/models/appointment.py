...
class Appointment(Base):
    ...
    last_source: Mapped[str | None] = mapped_column(String(30), nullable=True, index=True)
    sync_status: Mapped[str | None] = mapped_column(String(30), nullable=True, index=True)
    desktop_imported: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False, index=True)
